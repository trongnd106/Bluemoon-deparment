...
export default function ResidentForm(resident: any) {
  ...
  const handleAddResident = async (e: any) => {
    ...
    try {
      await axios.post("http://localhost:8080/api/v1/residents", data);
  ...
  return (
    <Form width="400px">
      <div>
        ...
        <Form.Fields>
          <FormField>
            ...
            <FormField.Input id="name" type="name" value={formValues.name} onChange={handleChange} />
          </FormField>
          <FormField>
            <FormField.Label label={"DOB"} />
            <FormField.Input id="dob" type="date" value={formValues.dob} onChange={handleChange} />
          </FormField>
          <FormField>
      ...
      <div>
        ...
        <Form.Fields>
          ...
          <FormField>
            ...
            <FormField.Select id="status" options={statusOptions} value={formValues.status} onChange={handleChange} />
          </FormField>
        </Form.Fields>
      </div>
      ...
      {resident ? (
        ...
        <Form.Buttons>
          <Button onClick={handleAddResident} size="medium" variation="primary" type="submit">
            Add
            <span>
              <HiOutlinePlusCircle />
            </span>
