...
export default function VehicleForm({ vehicle }: any) {
  ...
  const handleDelete = async (e: any) => {
    ...
    try {
      ...
      await axios.delete(`http://localhost:8080/api/v1/vehicles/${formValues.apartmentId}`, {
    ...
    <Form width="400px">
      <Form.Fields>
        <FormField>
          ...
          <FormField.Input id="apartmentId" type="text" value={formValues.apartmentId} onChange={handleChange} />
        </FormField>
